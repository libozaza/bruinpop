...
test("computeTier: defensive against non-finite input (all collapse to new_host)", () => {
  // Contract: Number.isFinite() rejects NaN, +/-Infinity, and non-numbers, so
  // all of these are treated as score=0. This is intentional -- an upstream
  // bug producing Infinity shouldn't crown a host campus_favorite.
