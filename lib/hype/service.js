 ...
 *   - Preserves relative ordering for the feed boost tiers.
 *   - Naturally floors at 0 (no negative results possible from $multiply on
 *     a >=0 base), so we don't need a max(0, ...) clamp here.
 *   - Common pattern for "social score half-life" mechanics.
 *
