 ...
 * @property {string} pinCategoryId - drives marker color on the map
 */
...
export function postToMapEvent(post) {
  ...
  const categories = cleanCategoryIds(post.categories);
  const pinCategoryId = getPrimaryCategoryId(categories);
