// [GenAI Use] this is a preview page for the posts composer and feed created using GenAI. It uses mock data and is not connected to the backend yet, but it shows how the UI will look and feel once the API routes are implemented. The PostComposer component is imported from components/PostComposer.jsx, and the mock posts are defined in the MOCK_POSTS array. The page is styled with Tailwind CSS and includes a header section with some info about the preview, as well as two main sections for composing a post and viewing the feed.
